...
public class BgOnClick2 : MonoBehaviour, IUnityAdsListener
{

    string gameId = "3524520";
    string myPlacementId = "bg_Theme2";
    bool testMode = true;
    ...
    {
        string isShowAds = PlayerPrefs.GetString("AdsBg2", "false");
    ...
    void SetBg()
    {
        ...
        PlayerPrefs.SetString("AdsBg2", "true");
