...
public class InitFruitLv14 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana3 = Instantiate(fruitsBanana, pos3a, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos4b, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos4c, Quaternion.identity);
