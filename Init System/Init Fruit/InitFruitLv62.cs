...
public class InitFruitLv62 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4b, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2d, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1f, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos1d, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
