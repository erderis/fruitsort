...
public class InitFruitLv108 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos3a, Quaternion.identity);
        cherry2 = Instantiate(fruitsCherry, pos1c, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos2c, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos2e, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4c, Quaternion.identity);
