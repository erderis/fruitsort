...
public class InitFruitLv30 : MonoBehaviour
{
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos3a, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos1c, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
