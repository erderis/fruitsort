...
public class InitFruitLv157 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos3g, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1j, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos2j, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos4e, Quaternion.identity); //pink
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos3d, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos3f, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos3e, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry3 = Instantiate(fruitsBlackBerry, pos1l, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos2b, Quaternion.identity);
