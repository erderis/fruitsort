...
public class InitFruitLv158 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos1f, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos3e, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos4f, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
