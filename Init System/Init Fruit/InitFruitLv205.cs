...
public class InitFruitLv205 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2c, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos4c, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos1e, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos1f, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos3b, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos4b, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos4k, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos3j, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos3d, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos3f, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3g, Quaternion.identity); //abu
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos2d, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos1h, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos3h, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos3c, Quaternion.identity); //kuning
