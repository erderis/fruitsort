...
public class InitFruitLv343 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos4f, Quaternion.identity); //orange
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos1f, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos1k, Quaternion.identity);
