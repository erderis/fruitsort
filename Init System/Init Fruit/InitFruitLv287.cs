...
public class InitFruitLv287 : MonoBehaviour
{
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos1e, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry3 = Instantiate(fruitsBlackBerry, pos4e, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos4h, Quaternion.identity); //hijau tua
