...
public class InitFruitLv268 : MonoBehaviour
{
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos2f, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin4 = Instantiate(fruitsPumpkin, pos3d, Quaternion.identity);
