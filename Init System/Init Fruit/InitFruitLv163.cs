...
public class InitFruitLv163 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos1b, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos1e, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos2h, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos3c, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos3e, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos4g, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4d, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos2f, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos3k, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos1l, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2c, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos3h, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos2i, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos1d, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos3l, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos2d, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos2k, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos2g, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos4b, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos1c, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos4i, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos1j, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1f, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos4f, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos3d, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos3f, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos3j, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos1g, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos1h, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos2e, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos3g, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos1i, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos4j, Quaternion.identity);
