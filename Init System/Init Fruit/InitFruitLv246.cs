...
public class InitFruitLv246 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos2a, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2c, Quaternion.identity);
        apple2 = Instantiate(fruitsApple, pos4c, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos2d, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos3d, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4b, Quaternion.identity);
