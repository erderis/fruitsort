...
public class InitFruitLv194 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos3d, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos1c, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos4d, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos3b, Quaternion.identity);
        pumpkin2 = Instantiate(fruitsPumpkin, pos3c, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos4c, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4a, Quaternion.identity);
