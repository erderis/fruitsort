...
public class InitFruitLv383 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1h, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos3i, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos3a, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos1i, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos2e, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos1c, Quaternion.identity);
