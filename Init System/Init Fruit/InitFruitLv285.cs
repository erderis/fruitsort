...
public class InitFruitLv285 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos4c, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos2d, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos1e, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos3h, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos1h, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos1l, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos3l, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos3g, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos4g, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos2b, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos1e, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos3e, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3c, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos4d, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos2f, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos4i, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos3f, Quaternion.identity); //coklat
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry4 = Instantiate(fruitsBlueBerry, pos1g, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos1j, Quaternion.identity);
