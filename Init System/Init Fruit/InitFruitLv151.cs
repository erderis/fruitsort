...
public class InitFruitLv151 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4f, Quaternion.identity); //merah
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos4b, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos4c, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4g, Quaternion.identity); //biru muda
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry3 = Instantiate(fruitsBlackBerry, pos3h, Quaternion.identity);
