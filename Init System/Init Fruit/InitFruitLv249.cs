...
public class InitFruitLv249 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos4i, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos3k, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos1g, Quaternion.identity); //hijau
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos1i, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos2b, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos3c, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos1f, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos4c, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos3d, Quaternion.identity);
