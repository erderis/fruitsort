...
public class InitFruitLv160 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos4c, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3f, Quaternion.identity);
