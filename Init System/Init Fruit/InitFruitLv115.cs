...
public class InitFruitLv115 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos4d, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos4i, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos4j, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos2a, Quaternion.identity); //merah
    ...
    void InstantiateBanana()
    {
        ...
        banana3 = Instantiate(fruitsBanana, pos2g, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos3k, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2b, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos3b, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos3l, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2c, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos3e, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos3f, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2f, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos1g, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos2h, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos2l, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos2d, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos4h, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos1b, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos3c, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos4e, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos4g, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos4k, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos4a, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos4b, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos3d, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos3g, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos1h, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos2k, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos1h, Quaternion.identity); //kuning
        ...
        manggoes4 = Instantiate(fruitsManggoes, pos3j, Quaternion.identity);
