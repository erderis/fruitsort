...
public class InitFruitLv375 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2b, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos1h, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos3i, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos4k, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos2f, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos4l, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos2c, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos1d, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos4g, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3d, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos1i, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos1j, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2a, Quaternion.identity); //biru muda
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos2h, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos3f, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos2j, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos3b, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos3c, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos4c, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos3g, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos1g, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos4f, Quaternion.identity); //kuning
