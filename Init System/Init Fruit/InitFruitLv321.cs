...
public class InitFruitLv321 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4g, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos3j, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos3e, Quaternion.identity);
