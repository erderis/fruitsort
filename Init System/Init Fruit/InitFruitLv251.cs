...
public class InitFruitLv251 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos3k, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1c, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos2c, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos1g, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos3l, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos3f, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos2g, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos3g, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos1i, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos1f, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos2f, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos2j, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos3j, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos3e, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos4e, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos3b, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos4f, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos1d, Quaternion.identity); //hijau tua
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3d, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos4d, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos3h, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos4a, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos3i, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos4j, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos3c, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos4c, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos1h, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos2d, Quaternion.identity); //kuning
