...
public class InitFruitLv347 : MonoBehaviour
{
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3g, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos3i, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos1g, Quaternion.identity);
