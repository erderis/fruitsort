...
public class InitFruitLv258 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos2c, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2d, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos4c, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2b, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3a, Quaternion.identity);
        eggplant2 = Instantiate(fruitsEggplant, pos4a, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos1b, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos1c, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos3d, Quaternion.identity);
