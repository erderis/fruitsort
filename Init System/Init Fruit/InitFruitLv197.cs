...
public class InitFruitLv197 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos1f, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1c, Quaternion.identity); //biru muda
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos1d, Quaternion.identity); //coklat
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos2d, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos3e, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos3f, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos1h, Quaternion.identity);
