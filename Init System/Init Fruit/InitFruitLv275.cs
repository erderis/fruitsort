...
public class InitFruitLv275 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos2h, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1d, Quaternion.identity); //merah
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos1j, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos3j, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos1g, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos4b, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos1c, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos4c, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin4 = Instantiate(fruitsPumpkin, pos4j, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos3g, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos2k, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos3d, Quaternion.identity); //coklat
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos4k, Quaternion.identity);
