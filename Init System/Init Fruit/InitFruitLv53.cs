...
public class InitFruitLv53 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos1g, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1f, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos4c, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2b, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos3f, Quaternion.identity);
