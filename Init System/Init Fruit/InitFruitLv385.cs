...
public class InitFruitLv385 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos1j, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos3e, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos1g, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos2j, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos2c, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos1f, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos4j, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4c, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos4e, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos4i, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos3l, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos1i, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos2i, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos4k, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos4d, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos2f, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos2h, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos3b, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos3d, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos1c, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos1d, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos2k, Quaternion.identity);
