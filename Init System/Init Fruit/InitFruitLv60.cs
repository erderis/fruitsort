...
public class InitFruitLv60: MonoBehaviour
{
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos3b, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos4b, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
