...
public class InitFruitLv235 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos3g, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos3i, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos1j, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos2a, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos4c, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos1l, Quaternion.identity);
