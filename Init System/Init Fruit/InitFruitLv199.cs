...
public class InitFruitLv199 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4e, Quaternion.identity); //biru
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos4d, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos4f, Quaternion.identity); //hijau tua
