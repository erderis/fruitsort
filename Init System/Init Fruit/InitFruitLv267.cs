...
public class InitFruitLv267 : MonoBehaviour
{
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos3j, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos4f, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos2l, Quaternion.identity);
