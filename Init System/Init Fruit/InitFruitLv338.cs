...
public class InitFruitLv338 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos4f, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1g, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos2d, Quaternion.identity);
