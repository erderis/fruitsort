...
public class InitFruitLv381 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4e, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos4g, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos2j, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos4f, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos1f, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos2h, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos4b, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos1e, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes4 = Instantiate(fruitsManggoes, pos1i, Quaternion.identity);
