...
public class InitFruitLv397 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos3c, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos2j, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos1l, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos2f, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos1g, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos4h, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos3j, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos3h, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos1h, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos3i, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos4d, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos1j, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos1e, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos4f, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin4 = Instantiate(fruitsPumpkin, pos2h, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos4e, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry4 = Instantiate(fruitsBlackBerry, pos4j, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos3e, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos3g, Quaternion.identity);
