...
public class InitFruitLv217 : MonoBehaviour
{
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2g, Quaternion.identity); //pink
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos2d, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos2k, Quaternion.identity);
