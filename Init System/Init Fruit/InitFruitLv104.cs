...
public class InitFruitLv104 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry4 = Instantiate(fruitsCherry, pos4f, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos3c, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
