...
public class InitFruitLv396 : MonoBehaviour
{
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos2b, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3c, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4g, Quaternion.identity);
