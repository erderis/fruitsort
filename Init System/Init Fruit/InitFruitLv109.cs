...
public class InitFruitLv109 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos3g, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos1b, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry4 = Instantiate(fruitsBlackBerry, pos3h, Quaternion.identity);
