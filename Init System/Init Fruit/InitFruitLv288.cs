...
public class InitFruitLv288 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos3c, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4c, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1c, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos4d, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2a, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1b, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos2c, Quaternion.identity);
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos1i, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos3a, Quaternion.identity);
        pumpkin2 = Instantiate(fruitsPumpkin, pos4a, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos2b, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1a, Quaternion.identity);
