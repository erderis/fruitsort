...
public class InitFruitLv181 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos4c, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3g, Quaternion.identity); //ungu
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry3 = Instantiate(fruitsBlackBerry, pos3k, Quaternion.identity);
