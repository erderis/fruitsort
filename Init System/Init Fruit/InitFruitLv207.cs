...
public class InitFruitLv207 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos1f, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos1d, Quaternion.identity); //pink
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos1b, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos2b, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos4d, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry4 = Instantiate(fruitsBlackBerry, pos1h, Quaternion.identity);
