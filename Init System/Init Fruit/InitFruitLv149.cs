...
public class InitFruitLv149 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2f, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos1j, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos4k, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1f, Quaternion.identity); //merah
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos1c, Quaternion.identity);
