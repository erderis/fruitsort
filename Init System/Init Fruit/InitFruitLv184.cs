...
public class InitFruitLv184 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4a, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos1d, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1e, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos2c, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos4c, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos3d, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
