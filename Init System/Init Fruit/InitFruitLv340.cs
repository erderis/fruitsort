...
public class InitFruitLv340 : MonoBehaviour
{
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2c, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos3e, Quaternion.identity);
