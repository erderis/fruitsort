...
public class InitFruitLv369 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos1d, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos3e, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos3i, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos2g, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos2b, Quaternion.identity); //coklat
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos3h, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos3j, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos2l, Quaternion.identity);
