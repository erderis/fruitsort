...
public class InitFruitLv247 : MonoBehaviour
{
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos4d, Quaternion.identity); //hijau
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos3h, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos2c, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos1f, Quaternion.identity); //kuning
