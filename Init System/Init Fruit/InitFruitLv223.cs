...
public class InitFruitLv223 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos1c, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos2c, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos2e, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry4 = Instantiate(fruitsCherry, pos4i, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos3j, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos1g, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos2g, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos2i, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos3k, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos4g, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos2j, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos3f, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos1e, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos3i, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos1l, Quaternion.identity);
