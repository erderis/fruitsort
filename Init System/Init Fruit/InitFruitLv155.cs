...
public class InitFruitLv155 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos3j, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos3a, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos1c, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos2c, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos4l, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos4g, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos3c, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos3d, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos3f, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos3g, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos1l, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos1d, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3e, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos1h, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos2i, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos1j, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos1e, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos1g, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4b, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos2e, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos4e, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos2f, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos2h, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos1b, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos2d, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos1f, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos2g, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos4h, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos4i, Quaternion.identity);
