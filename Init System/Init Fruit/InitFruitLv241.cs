...
public class InitFruitLv241 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos1d, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos3d, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos1h, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos4g, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos3f, Quaternion.identity); //biru muda
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos4i, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos2e, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos3g, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos3j, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos2c, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos3c, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos2d, Quaternion.identity); //hijau tua
        ...
        blueberry4 = Instantiate(fruitsBlueBerry, pos3h, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos2h, Quaternion.identity);
