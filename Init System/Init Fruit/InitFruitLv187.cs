...
public class InitFruitLv187 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos3h, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos2k, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos2g, Quaternion.identity);
