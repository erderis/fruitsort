...
public class InitFruitLv265 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos4b, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos3c, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos1d, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana3 = Instantiate(fruitsBanana, pos1g, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos1b, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos3j, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos2b, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2f, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos3i, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos4g, Quaternion.identity); //coklat
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos1e, Quaternion.identity);
