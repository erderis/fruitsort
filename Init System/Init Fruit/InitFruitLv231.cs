...
public class InitFruitLv231 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos1e, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos1j, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos3j, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos3d, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos1g, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos1h, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos4f, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos4a, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos2d, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos4d, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos4i, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos2g, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3a, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos3c, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos2j, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos4e, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos4g, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos4h, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos1f, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos3e, Quaternion.identity);
