...
public class InitFruitLv124 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2b, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1c, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos1b, Quaternion.identity);
        apple2 = Instantiate(fruitsApple, pos1d, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos1e, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos1g, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos1a, Quaternion.identity);
        melon2 = Instantiate(fruitsMelon, pos3a, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos4b, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2a, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos3e, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2e, Quaternion.identity);
