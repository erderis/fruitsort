...
public class InitFruitLv203 : MonoBehaviour
{
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos4g, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos2i, Quaternion.identity);
