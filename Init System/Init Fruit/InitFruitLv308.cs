...
public class InitFruitLv308 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry4 = Instantiate(fruitsCherry, pos4d, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos3f, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2e, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos1d, Quaternion.identity);
