...
public class InitFruitLv297 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1e, Quaternion.identity); //biru
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos1j, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos2l, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry4 = Instantiate(fruitsBlueBerry, pos3i, Quaternion.identity);
