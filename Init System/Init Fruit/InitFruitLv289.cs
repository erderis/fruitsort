...
public class InitFruitLv289 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos2e, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos1j, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos1e, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2f, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos3g, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos2i, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos2b, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos3f, Quaternion.identity);
