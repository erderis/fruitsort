...
public class InitFruitLv147 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos1f, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4c, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos2d, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos2f, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos3f, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4h, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos3j, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos3k, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos4k, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos3e, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos3h, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos3i, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos2k, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos1d, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos2g, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos2h, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2b, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos2c, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos3d, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos4d, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3a, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos3b, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos4e, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos1g, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos1i, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1c, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos3g, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos1k, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos3l, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos4b, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos2e, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos2l, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos4a, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos1b, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos4f, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos2i, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos1e, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos4g, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos4i, Quaternion.identity);
