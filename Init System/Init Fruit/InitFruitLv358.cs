...
public class InitFruitLv358 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos4f, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos2i, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3d, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos3c, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3f, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos2d, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
