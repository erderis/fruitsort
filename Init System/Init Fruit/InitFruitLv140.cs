...
public class InitFruitLv140 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry4 = Instantiate(fruitsCherry, pos3c, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2f, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos2a, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3d, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4e, Quaternion.identity);
