...
public class InitFruitLv234 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos4a, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1b, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4b, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos3a, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3b, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4d, Quaternion.identity);
        grape2 = Instantiate(fruitsGrape, pos1g, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos3g, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos1h, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
