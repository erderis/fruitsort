...
public class InitFruitLv233 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos2c, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos4g, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos4j, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry3 = Instantiate(fruitsBlackBerry, pos2d, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos2f, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos2g, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos1h, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos2l, Quaternion.identity);
