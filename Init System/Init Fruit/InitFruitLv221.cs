...
public class InitFruitLv221 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos4g, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1f, Quaternion.identity); //abu
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos1h, Quaternion.identity); //hijau tua
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos4d, Quaternion.identity);
