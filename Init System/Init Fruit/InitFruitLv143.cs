...
public class InitFruitLv143 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos4d, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos4f, Quaternion.identity); //pink
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos2i, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos3h, Quaternion.identity);
