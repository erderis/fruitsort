...
public class InitFruitLv339 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos1g, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos1i, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos1k, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos2l, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4b, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos2d, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos1e, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos2j, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos3b, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos1c, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos3d, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos1h, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos2b, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos1j, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos4l, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3c, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos4e, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos3h, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos2i, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4a, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos1d, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos3f, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos4g, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos2c, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos4d, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos3g, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos2h, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos2f, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos4f, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos2g, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos4k, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3e, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos1f, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos4h, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos1l, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos2a, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos2e, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos3i, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos4c, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos3j, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos3k, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos4j, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos2k, Quaternion.identity);
