...
public class InitFruitLv312 : MonoBehaviour
{
    ...
    {
        apple1 = Instantiate(fruitsApple, pos3e, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos1b, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos4d, Quaternion.identity);
