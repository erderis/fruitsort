...
public class InitFruitLv359 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos1g, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos2d, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos4e, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos3j, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana3 = Instantiate(fruitsBanana, pos2e, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos3e, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2a, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos3d, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos2g, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos3k, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos3c, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos4b, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos1e, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos3h, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos4g, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos4h, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos4f, Quaternion.identity);
