...
public class InitFruitLv136 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2c, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos3d, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos4a, Quaternion.identity);
