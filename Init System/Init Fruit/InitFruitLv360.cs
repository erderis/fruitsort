...
public class InitFruitLv360 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos1c, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1e, Quaternion.identity);
