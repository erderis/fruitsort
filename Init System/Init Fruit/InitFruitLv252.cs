...
public class InitFruitLv252 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos4c, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos3d, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos2f, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3a, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos2d, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos4e, Quaternion.identity);
