...
public class InitFruitLv122 : MonoBehaviour
{
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2c, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos1f, Quaternion.identity);
