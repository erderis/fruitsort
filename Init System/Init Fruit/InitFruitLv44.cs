...
public class InitFruitLv44 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos4c, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1b, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos4a, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos3b, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos2d, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos1a, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3d, Quaternion.identity);
