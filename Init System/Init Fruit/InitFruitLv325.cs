...
public class InitFruitLv325 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos4e, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos3i, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos4j, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos2k, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos2c, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos4f, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos4a, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos4c, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2e, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos1i, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos4i, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos1j, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3a, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos4b, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos1d, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos2g, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4d, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos2f, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos4g, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos3h, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos2i, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos1f, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos2h, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos4h, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos3d, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos3j, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos3k, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos1c, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos3c, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos1e, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos3b, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos3f, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos1k, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos1b, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos2b, Quaternion.identity);
