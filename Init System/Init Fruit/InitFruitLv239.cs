...
public class InitFruitLv239 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos4i, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos1j, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos1g, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos1c, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos3e, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos4g, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos1h, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos3h, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos1i, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos2k, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos4e, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos3f, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos4k, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos4c, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos1d, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos3i, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos2e, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos4h, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos4d, Quaternion.identity); //kuning
