...
public class InitFruitLv226 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4e, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos3f, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos4c, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4d, Quaternion.identity);
