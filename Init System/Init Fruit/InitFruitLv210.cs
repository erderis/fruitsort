...
public class InitFruitLv210 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos3e, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4f, Quaternion.identity);
