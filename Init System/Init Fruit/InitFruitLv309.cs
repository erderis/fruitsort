...
public class InitFruitLv309 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2g, Quaternion.identity); //orange
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos4h, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana3 = Instantiate(fruitsBanana, pos2b, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos3f, Quaternion.identity); //pink
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos4f, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos1j, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos4c, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos3g, Quaternion.identity);
