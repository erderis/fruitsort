...
public class InitFruitLv174 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4c, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos2i, Quaternion.identity);
