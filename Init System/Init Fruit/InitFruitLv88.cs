...
public class InitFruitLv88 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1d, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos4a, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3e, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos3a, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos4b, Quaternion.identity);
        pumpkin2 = Instantiate(fruitsPumpkin, pos3c, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos4d, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos2f, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2b, Quaternion.identity);
        grape2 = Instantiate(fruitsGrape, pos3d, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos1e, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos1g, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
