...
public class InitFruitLv206 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2a, Quaternion.identity);
        orange2 = Instantiate(fruitsOrange, pos4e, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos1f, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos2i, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1e, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2b, Quaternion.identity);
        banana2 = Instantiate(fruitsBanana, pos3b, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos1c, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos2e, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos3a, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos4b, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos4c, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos4a, Quaternion.identity);
