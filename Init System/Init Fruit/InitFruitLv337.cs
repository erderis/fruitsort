...
public class InitFruitLv337 : MonoBehaviour
{
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos1j, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos2c, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos1d, Quaternion.identity);
