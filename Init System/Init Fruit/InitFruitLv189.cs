...
public class InitFruitLv189 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos1b, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana3 = Instantiate(fruitsBanana, pos2d, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4g, Quaternion.identity); //ungu
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos1j, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos2j, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos3l, Quaternion.identity);
