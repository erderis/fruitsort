...
public class InitFruitLv201 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos4c, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos1l, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1d, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos2d, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos4f, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos2f, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2g, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos2k, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos4k, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos2j, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos3h, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4h, Quaternion.identity); //ungu
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry4 = Instantiate(fruitsBlueBerry, pos1j, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos3c, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos4d, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos4g, Quaternion.identity);
