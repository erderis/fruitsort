...
public class InitFruitLv117 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos2e, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry4 = Instantiate(fruitsCherry, pos3g, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1b, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos1c, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos3c, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos4j, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos1l, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos4c, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos4e, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos1g, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos2g, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos1h, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos3h, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos3i, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos1j, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos2k, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos4d, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos1i, Quaternion.identity);
