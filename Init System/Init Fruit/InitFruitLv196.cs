...
public class InitFruitLv196 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos2i, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2a, Quaternion.identity);
        apple2 = Instantiate(fruitsApple, pos4a, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos3c, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos1e, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2d, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos3d, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1c, Quaternion.identity);
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos2g, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3a, Quaternion.identity);
