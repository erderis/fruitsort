...
public class InitFruitLv255 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos2b, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos2d, Quaternion.identity); //hijau tua
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos2h, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos2j, Quaternion.identity);
