...
public class InitFruitLv357 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos1d, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos4g, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry4 = Instantiate(fruitsCherry, pos1i, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4b, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos4d, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos1h, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos2i, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos4i, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos1j, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos3l, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos4c, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos2d, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos4h, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos2k, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos3h, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos3i, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos3j, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3b, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos1f, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos1l, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos2l, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos3d, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos3f, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2c, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos2e, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos1g, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry3 = Instantiate(fruitsBlackBerry, pos4f, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos2g, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos2a, Quaternion.identity); //kuning
        ...
        manggoes4 = Instantiate(fruitsManggoes, pos3e, Quaternion.identity);
