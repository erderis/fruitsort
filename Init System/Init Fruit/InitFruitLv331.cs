...
public class InitFruitLv331 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2e, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos4f, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos1h, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos1j, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos1b, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos3b, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1g, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos1i, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos3i, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos4e, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos2f, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos2j, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos4h, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos4i, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos3g, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos2a, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos4b, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos3c, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos2b, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos3f, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos2i, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos2k, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos4g, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos4d, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos1f, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos4j, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos2h, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos1l, Quaternion.identity);
