...
public class InitFruitLv353 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos1c, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2h, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos3k, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1d, Quaternion.identity); //abu
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos3d, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos1e, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos2g, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos1l, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos2e, Quaternion.identity); //coklat
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos2c, Quaternion.identity);
