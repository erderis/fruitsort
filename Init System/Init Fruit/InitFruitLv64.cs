...
public class InitFruitLv64 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4e, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos2a, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4f, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin4 = Instantiate(fruitsPumpkin, pos3e, Quaternion.identity);
