...
public class InitFruitLv319 : MonoBehaviour
{
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos2h, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos2c, Quaternion.identity);
