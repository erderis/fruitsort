...
public class InitFruitLv281 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos1j, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos2d, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos4c, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos2k, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos4h, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1f, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos2j, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos3j, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos3f, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos4j, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos1g, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos3d, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos2f, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos3g, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos4g, Quaternion.identity);
