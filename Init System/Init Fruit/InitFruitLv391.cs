...
public class InitFruitLv391 : MonoBehaviour
{
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3h, Quaternion.identity); //abu
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos2a, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos1f, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
