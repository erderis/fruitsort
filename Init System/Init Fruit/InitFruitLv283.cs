...
public class InitFruitLv283 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos3e, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos3g, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos2j, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos1l, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4d, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos4g, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos2h, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4c, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos2e, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos1i, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos3i, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos4b, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos1g, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos1h, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos2i, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2a, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos3b, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos2g, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos4i, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4e, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos1f, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos3f, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos4k, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1a, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos4f, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos3h, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos3l, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos4a, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos4j, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos1l, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1b, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos1c, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos1d, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos1e, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos2c, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos3c, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos2f, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos1k, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos1j, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos3j, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos3k, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos2l, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos2b, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos2d, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos3d, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos4h, Quaternion.identity);
