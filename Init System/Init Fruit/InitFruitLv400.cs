...
public class InitFruitLv400 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos3b, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos2e, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1f, Quaternion.identity);
