...
public class InitFruitLv139 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos2g, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4f, Quaternion.identity); //biru
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos1d, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos3b, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos2e, Quaternion.identity);
