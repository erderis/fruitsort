...
public class InitFruitLv195 : MonoBehaviour
{
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos3e, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos1g, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos4d, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos1j, Quaternion.identity);
