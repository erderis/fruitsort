...
public class InitFruitLv354 : MonoBehaviour
{
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos1b, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos3b, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos3a, Quaternion.identity);
