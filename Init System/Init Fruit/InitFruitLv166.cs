...
public class InitFruitLv166 : MonoBehaviour
{
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos2d, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos4a, Quaternion.identity);
