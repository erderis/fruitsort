...
public class InitFruitLv179 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos3f, Quaternion.identity); //orange
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos2k, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos4k, Quaternion.identity);
