...
public class InitFruitLv341 : MonoBehaviour
{
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos1g, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos2h, Quaternion.identity); //abu
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry4 = Instantiate(fruitsBlackBerry, pos2i, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes4 = Instantiate(fruitsManggoes, pos1h, Quaternion.identity);
