...
public class InitFruitLv237 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2h, Quaternion.identity); //orange
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos3h, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos1d, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos4e, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos4f, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos3e, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos3k, Quaternion.identity);
