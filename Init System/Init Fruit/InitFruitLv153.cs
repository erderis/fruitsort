...
public class InitFruitLv153 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos3d, Quaternion.identity); //merah
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos3h, Quaternion.identity); //biru
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos4f, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos1f, Quaternion.identity); //hijau
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos2h, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos4h, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos2c, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos2d, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos1h, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry4 = Instantiate(fruitsBlueBerry, pos4g, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos3f, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos3i, Quaternion.identity);
