...
public class InitFruitLv113 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos2k, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos2h, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos1d, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos2e, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos4h, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos4i, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos1j, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos3i, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos4a, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos2b, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos3d, Quaternion.identity);
