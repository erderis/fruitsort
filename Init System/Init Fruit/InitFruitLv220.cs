...
public class InitFruitLv220 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos3d, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos3e, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos3c, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos3f, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3g, Quaternion.identity);
