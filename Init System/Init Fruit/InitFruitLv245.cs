...
public class InitFruitLv245 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos3d, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos3e, Quaternion.identity); //merah
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos4j, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos1e, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos2f, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos4i, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos2l, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos1f, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos4k, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos3l, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4b, Quaternion.identity); //biru muda
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos1h, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos4h, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos1j, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos1k, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos3k, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2b, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos2c, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos2h, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry4 = Instantiate(fruitsBlackBerry, pos1i, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry4 = Instantiate(fruitsBlueBerry, pos3j, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos3i, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos2k, Quaternion.identity);
