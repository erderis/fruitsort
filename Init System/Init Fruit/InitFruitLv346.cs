...
public class InitFruitLv346 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos1a, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos2a, Quaternion.identity);
        cherry2 = Instantiate(fruitsCherry, pos3a, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos4b, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos2f, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2c, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2g, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos1c, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos3e, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos4a, Quaternion.identity);
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos4d, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos1b, Quaternion.identity);
        pumpkin2 = Instantiate(fruitsPumpkin, pos4c, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos3h, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos4i, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1d, Quaternion.identity);
        grape2 = Instantiate(fruitsGrape, pos1e, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos4h, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos2i, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
