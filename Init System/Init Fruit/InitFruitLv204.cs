...
public class InitFruitLv204 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos3d, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos1f, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
