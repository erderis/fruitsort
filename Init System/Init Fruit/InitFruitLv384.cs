...
public class InitFruitLv384 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos3b, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos3c, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1a, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4a, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1d, Quaternion.identity);
        eggplant2 = Instantiate(fruitsEggplant, pos3d, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos4d, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos1e, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3e, Quaternion.identity);
        grape2 = Instantiate(fruitsGrape, pos4e, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos1f, Quaternion.identity);
