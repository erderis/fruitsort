...
public class InitFruitLv128 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos1c, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos4a, Quaternion.identity);
        cherry2 = Instantiate(fruitsCherry, pos3b, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos4d, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos1e, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2b, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos4g, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos2e, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2a, Quaternion.identity);
        grape2 = Instantiate(fruitsGrape, pos2c, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos3c, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos4e, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
