...
public class InitFruitLv361 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana3 = Instantiate(fruitsBanana, pos4i, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos2h, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2e, Quaternion.identity); //biru muda
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos1g, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos1h, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos3f, Quaternion.identity);
