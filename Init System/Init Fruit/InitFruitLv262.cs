...
public class InitFruitLv262 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos3c, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos3d, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
