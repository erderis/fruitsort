...
public class InitFruitLv274 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos3b, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos3c, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos4a, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos3d, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos4d, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1c, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1b, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos2b, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2c, Quaternion.identity);
