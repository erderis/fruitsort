...
public class InitFruitLv374 : MonoBehaviour
{
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1f, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos3d, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2d, Quaternion.identity);
