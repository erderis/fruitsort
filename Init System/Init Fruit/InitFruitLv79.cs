...
public class InitFruitLv79 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos1d, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1a, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2e, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos4b, Quaternion.identity);
