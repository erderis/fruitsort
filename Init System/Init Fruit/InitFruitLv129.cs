...
public class InitFruitLv129 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos3i, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2g, Quaternion.identity); //hijau
