...
public class InitFruitLv257 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos2f, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos4g, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos4k, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1e, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos2e, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos3e, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos1g, Quaternion.identity); //hijau tua
