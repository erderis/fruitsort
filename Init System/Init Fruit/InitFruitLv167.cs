...
public class InitFruitLv167 : MonoBehaviour
{
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1i, Quaternion.identity); //biru muda
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos3k, Quaternion.identity);
