...
public class InitFruitLv243 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2d, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos1e, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos1h, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos3k, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos2b, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos2h, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos4d, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos2g, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos2j, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos1c, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos3g, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos3b, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos3d, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos3e, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos2i, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos2c, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos2e, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos4e, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos3h, Quaternion.identity);
