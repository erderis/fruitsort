...
public class InitFruitLv355 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos4b, Quaternion.identity); //orange
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2f, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos3f, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos2h, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos2e, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos3c, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos1g, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos3g, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos4g, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos2c, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos1e, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos4j, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos1i, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos1d, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos4f, Quaternion.identity);
