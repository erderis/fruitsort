...
public class InitFruitLv193 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos1b, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos3i, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1i, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos2j, Quaternion.identity);
