...
public class InitFruitLv389 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry4 = Instantiate(fruitsCherry, pos3i, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1d, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos2d, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos1e, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos4e, Quaternion.identity); //abu
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos4a, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos4b, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos2f, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4c, Quaternion.identity); //ungu
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos3b, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos2k, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos4k, Quaternion.identity);
