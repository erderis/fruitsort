...
public class InitFruitLv59 : MonoBehaviour
{
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos2f, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1a, Quaternion.identity);
