...
public class InitFruitLv165 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos4d, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos3f, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos3g, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos2h, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1a, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos1e, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos1g, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos4k, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1a, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos2b, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos1f, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos2j, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos2d, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos1i, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos4i, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos4g, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos2k, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos2l, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos1c, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos1h, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos3h, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos2i, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos3i, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos2a, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos3b, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos3c, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos2e, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4d, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos2f, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos4f, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos1k, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos4e, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos3j, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos4j, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos1d, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos4h, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos1j, Quaternion.identity);
