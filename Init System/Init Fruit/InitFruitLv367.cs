...
public class InitFruitLv367 : MonoBehaviour
{
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2g, Quaternion.identity); //ungu
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos4e, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos3i, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos3j, Quaternion.identity);
