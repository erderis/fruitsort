...
public class InitFruitLv295 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos3b, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos4b, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos1c, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos2c, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos3h, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2b, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos1d, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos4j, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos1l, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos2l, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos3e, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos1g, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos2g, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos2h, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1a, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos4c, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos1i, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos3k, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3c, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos1f, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos4e, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos4h, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos2d, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos4d, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos1e, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos3f, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos3g, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos3i, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos1j, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos3a, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos4i, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos3j, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos4k, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos4a, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos2e, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos2f, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos4f, Quaternion.identity);
