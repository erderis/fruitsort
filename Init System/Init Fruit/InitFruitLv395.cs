...
public class InitFruitLv395 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos1i, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos4i, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin4 = Instantiate(fruitsPumpkin, pos4h, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry2 = Instantiate(fruitsBlackBerry, pos1b, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos2j, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos4g, Quaternion.identity);
