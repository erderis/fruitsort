...
public class InitFruitLv137 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos3g, Quaternion.identity); //biru
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry4 = Instantiate(fruitsBlueBerry, pos1e, Quaternion.identity);
