...
public class InitFruitLv185 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos1c, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos3c, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos3d, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos2k, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos2e, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos3f, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos2f, Quaternion.identity);
