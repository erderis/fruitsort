...
public class InitFruitLv291 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos1f, Quaternion.identity); //biru
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2d, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos4d, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos3e, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos1l, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos2i, Quaternion.identity); //hijau tua
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos2j, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes3 = Instantiate(fruitsManggoes, pos1c, Quaternion.identity);
