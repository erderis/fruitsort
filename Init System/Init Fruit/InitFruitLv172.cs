...
public class InitFruitLv172 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2e, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos3a, Quaternion.identity);
