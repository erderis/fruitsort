...
public class InitFruitLv335 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos4g, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape4 = Instantiate(fruitsGrape, pos3g, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
