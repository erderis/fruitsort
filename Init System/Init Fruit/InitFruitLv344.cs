...
public class InitFruitLv344 : MonoBehaviour
{
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2d, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos3a, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos1e, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos2e, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
