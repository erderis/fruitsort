...
public class InitFruitLv49 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana3 = Instantiate(fruitsBanana, pos4b, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos4c, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos1c, Quaternion.identity);
