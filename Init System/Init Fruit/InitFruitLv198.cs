...
public class InitFruitLv198 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            banana1 = Instantiate(fruitsBanana, pos1g, Quaternion.identity);
        ...
        {
            strawberry1 = Instantiate(fruitsStrawberry, pos3h, Quaternion.identity);
        ...
        void InstantiateEggplant()
        {
            ...
            eggplant3 = Instantiate(fruitsEggplant, pos1d, Quaternion.identity);
        ...
        {
            grape1 = Instantiate(fruitsGrape, pos3b, Quaternion.identity);
            grape2 = Instantiate(fruitsGrape, pos4b, Quaternion.identity);
            grape3 = Instantiate(fruitsGrape, pos2d, Quaternion.identity);
