...
public class InitFruitLv103 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos3a, Quaternion.identity); //orange
        orange2 = Instantiate(fruitsOrange, pos1j, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos2l, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos4g, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos3f, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos2g, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos3h, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos2h, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos2i, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos1l, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateMelon()
    {
        ...
        melon2 = Instantiate(fruitsMelon, pos2c, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos1b, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos4d, Quaternion.identity); //abu
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos1h, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos1f, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos3f, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos1g, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos4b, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos1e, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos2f, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos3b, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos1d, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos4e, Quaternion.identity);
