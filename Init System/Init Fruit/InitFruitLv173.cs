...
public class InitFruitLv173 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos3d, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos4d, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos4h, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos3h, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos3b, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos3j, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos2e, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos4i, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos3a, Quaternion.identity);
