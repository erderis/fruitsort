...
public class InitFruitLv50 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4d, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos2f, Quaternion.identity);
