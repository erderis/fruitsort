...
public class InitFruitLv329 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos2l, Quaternion.identity);
        orange3 = Instantiate(fruitsOrange, pos3l, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos1h, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos3h, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos3k, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2a, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos3a, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos2c, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos4i, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos1e, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos1g, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos2b, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos2e, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2d, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos4h, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos1j, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos4j, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos4c, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos3d, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos2g, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos1l, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos3b, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos4d, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos1f, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos2j, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos4a, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos2f, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos4g, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos1b, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos3e, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos3g, Quaternion.identity);
        blackberry4 = Instantiate(fruitsBlackBerry, pos2k, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos1d, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos4f, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos3j, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos1k, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos1c, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos4e, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos3f, Quaternion.identity);
