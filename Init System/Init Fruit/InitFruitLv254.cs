...
public class InitFruitLv254 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos4b, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos1e, Quaternion.identity);
        melon2 = Instantiate(fruitsMelon, pos3e, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos2g, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos1i, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos1c, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1b, Quaternion.identity);
        grape2 = Instantiate(fruitsGrape, pos2d, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos4f, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos4g, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
