...
public class InitFruitLv183 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos2d, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos1e, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos4j, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos3e, Quaternion.identity); //biru muda
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos2a, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos1c, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos2b, Quaternion.identity); //hijau tua
