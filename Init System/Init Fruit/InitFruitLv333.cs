...
public class InitFruitLv333 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos3l, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos4h, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry4 = Instantiate(fruitsStrawberry, pos1f, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos4g, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos3h, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos1j, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin3 = Instantiate(fruitsPumpkin, pos2e, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape2 = Instantiate(fruitsGrape, pos1h, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos3d, Quaternion.identity); //hijau tua
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes4 = Instantiate(fruitsManggoes, pos3g, Quaternion.identity);
