...
public class InitFruitLv46 : MonoBehaviour
{
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1d, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos1e, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos3b, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos3h, Quaternion.identity);
