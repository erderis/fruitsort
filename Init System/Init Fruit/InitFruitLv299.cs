...
public class InitFruitLv299 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos2g, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos3c, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos1j, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple3 = Instantiate(fruitsApple, pos4b, Quaternion.identity);
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos1c, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos1e, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos2k, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos4f, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos1h, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos2d, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos2f, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos3g, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos3i, Quaternion.identity);
    ...
    void InstantiateGrape()
    {
        ...
        grape3 = Instantiate(fruitsGrape, pos2e, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos1f, Quaternion.identity); //hijau tua
        blueberry2 = Instantiate(fruitsBlueBerry, pos4h, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos4i, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos2a, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos1g, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos2i, Quaternion.identity);
