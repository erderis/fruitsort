...
public class InitFruitLv16 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos1e, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos1b, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos3b, Quaternion.identity);
