...
public class InitFruitLv213 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos1g, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2c, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos4c, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos1e, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos2f, Quaternion.identity);
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry3 = Instantiate(fruitsStrawberry, pos2g, Quaternion.identity);
        strawberry4 = Instantiate(fruitsStrawberry, pos4l, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos3d, Quaternion.identity); //abu
        ...
        eggplant4 = Instantiate(fruitsEggplant, pos3i, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos4d, Quaternion.identity); //coklat
        ...
        blackberry4 = Instantiate(fruitsBlackBerry, pos1l, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos3h, Quaternion.identity);
