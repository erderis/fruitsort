...
public class InitFruitLv253 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos1g, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2h, Quaternion.identity); //pink
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos3f, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos2k, Quaternion.identity);
