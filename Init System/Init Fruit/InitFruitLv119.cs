...
public class InitFruitLv119 : MonoBehaviour
{
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4a, Quaternion.identity); //biru
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos4h, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos1e, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos4j, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos4f, Quaternion.identity); //abu
