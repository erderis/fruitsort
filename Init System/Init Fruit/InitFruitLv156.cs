...
public class InitFruitLv156 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos3e, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos2g, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateMelon()
    {
        ...
        melon3 = Instantiate(fruitsMelon, pos2c, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos4b, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1e, Quaternion.identity);
