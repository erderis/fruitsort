...
public class InitFruitLv159 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange4 = Instantiate(fruitsOrange, pos3f, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos2l, Quaternion.identity);
    ...
    {
        blueberry1 = Instantiate(fruitsBlueBerry, pos4e, Quaternion.identity); //hijau tua
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes2 = Instantiate(fruitsManggoes, pos1f, Quaternion.identity);
