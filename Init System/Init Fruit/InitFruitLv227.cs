...
public class InitFruitLv227 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos3h, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana2 = Instantiate(fruitsBanana, pos2i, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos2k, Quaternion.identity);
    ...
    void InstantiateMelon()
    {
        ...
        melon4 = Instantiate(fruitsMelon, pos4e, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin2 = Instantiate(fruitsPumpkin, pos1k, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos1l, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3f, Quaternion.identity); //ungu
