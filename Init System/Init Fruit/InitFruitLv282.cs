...
public class InitFruitLv282 : MonoBehaviour
{
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos4d, Quaternion.identity);
    ...
    void InstantiatePumpkin()
    {
        ...
        pumpkin4 = Instantiate(fruitsPumpkin, pos2d, Quaternion.identity);
