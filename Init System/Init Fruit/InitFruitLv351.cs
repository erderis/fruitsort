...
public class InitFruitLv351 : MonoBehaviour
{
    ...
    void InstantiateCherry()
    {
        ...
        cherry2 = Instantiate(fruitsCherry, pos4i, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant2 = Instantiate(fruitsEggplant, pos1j, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos3l, Quaternion.identity);
    ...
    void InstantiateBlackBerry()
    {
        ...
        blackberry4 = Instantiate(fruitsBlackBerry, pos1f, Quaternion.identity);
