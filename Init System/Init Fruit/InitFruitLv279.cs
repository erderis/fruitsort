...
public class InitFruitLv279 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos2a, Quaternion.identity);
    ...
    void InstantiateCherry()
    {
        ...
        cherry3 = Instantiate(fruitsCherry, pos2d, Quaternion.identity);
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos2h, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple4 = Instantiate(fruitsApple, pos4j, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    void InstantiateStrawberry()
    {
        ...
        strawberry2 = Instantiate(fruitsStrawberry, pos4f, Quaternion.identity);
    ...
    void InstantiateEggplant()
    {
        ...
        eggplant3 = Instantiate(fruitsEggplant, pos1h, Quaternion.identity);
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos1e, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos2e, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos3e, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry3 = Instantiate(fruitsBlueBerry, pos2i, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos3i, Quaternion.identity); //kuning
