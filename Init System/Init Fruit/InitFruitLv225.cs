...
public class InitFruitLv225 : MonoBehaviour
{
    ...
    {
        apple1 = Instantiate(fruitsApple, pos2j, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos3k, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry4 = Instantiate(fruitsBlueBerry, pos3f, Quaternion.identity);
    ...
    void InstantiateManggoes()
    {
        ...
        manggoes4 = Instantiate(fruitsManggoes, pos2h, Quaternion.identity);
