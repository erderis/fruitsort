...
public class InitFruitLv71 : MonoBehaviour
{
    ...
    void InstantiateBanana()
    {
        ...
        banana4 = Instantiate(fruitsBanana, pos4e, Quaternion.identity);
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos2f, Quaternion.identity);
