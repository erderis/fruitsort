...
public class InitFruitLv305 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange3 = Instantiate(fruitsOrange, pos3f, Quaternion.identity);
        orange4 = Instantiate(fruitsOrange, pos3l, Quaternion.identity);
    ...
    {
        cherry1 = Instantiate(fruitsCherry, pos1e, Quaternion.identity); //merah
        cherry2 = Instantiate(fruitsCherry, pos4e, Quaternion.identity);
        cherry3 = Instantiate(fruitsCherry, pos3k, Quaternion.identity);
        cherry4 = Instantiate(fruitsCherry, pos2l, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos2e, Quaternion.identity); //biru
        banana2 = Instantiate(fruitsBanana, pos2f, Quaternion.identity);
        banana3 = Instantiate(fruitsBanana, pos4g, Quaternion.identity);
        banana4 = Instantiate(fruitsBanana, pos2k, Quaternion.identity);
    ...
    {
        apple1 = Instantiate(fruitsApple, pos3a, Quaternion.identity); //pink
        apple2 = Instantiate(fruitsApple, pos4a, Quaternion.identity);
        apple3 = Instantiate(fruitsApple, pos1d, Quaternion.identity);
        apple4 = Instantiate(fruitsApple, pos3j, Quaternion.identity);
        apple1.name = "apple1";
        apple2.name = "apple2";
        apple3.name = "apple3";
        apple4.name = "apple4";
    ...
    {
        melon1 = Instantiate(fruitsMelon, pos4b, Quaternion.identity); //hijau
        melon2 = Instantiate(fruitsMelon, pos4c, Quaternion.identity);
        melon3 = Instantiate(fruitsMelon, pos4d, Quaternion.identity);
        melon4 = Instantiate(fruitsMelon, pos3e, Quaternion.identity);
        melon1.name = "melon1";
        melon2.name = "melon2";
        melon3.name = "melon3";
        melon4.name = "melon4";
    ...
    {
        strawberry1 = Instantiate(fruitsStrawberry, pos3i, Quaternion.identity); //biru muda
        strawberry2 = Instantiate(fruitsStrawberry, pos4i, Quaternion.identity);
        strawberry3 = Instantiate(fruitsStrawberry, pos4j, Quaternion.identity);
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1c, Quaternion.identity); //abu
        eggplant2 = Instantiate(fruitsEggplant, pos3d, Quaternion.identity);
        eggplant3 = Instantiate(fruitsEggplant, pos2h, Quaternion.identity);
        eggplant4 = Instantiate(fruitsEggplant, pos4l, Quaternion.identity);
    ...
    {
        pumpkin1 = Instantiate(fruitsPumpkin, pos3c, Quaternion.identity); //hijau tua
        pumpkin2 = Instantiate(fruitsPumpkin, pos1f, Quaternion.identity);
        pumpkin3 = Instantiate(fruitsPumpkin, pos4f, Quaternion.identity);
        pumpkin4 = Instantiate(fruitsPumpkin, pos1g, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos1a, Quaternion.identity); //ungu
        grape2 = Instantiate(fruitsGrape, pos2b, Quaternion.identity);
        grape3 = Instantiate(fruitsGrape, pos3b, Quaternion.identity);
        grape4 = Instantiate(fruitsGrape, pos1j, Quaternion.identity);
        grape1.name = "grape1";
        grape2.name = "grape2";
        grape3.name = "grape3";
        grape4.name = "grape4";
    ...
    {
        blackberry1 = Instantiate(fruitsBlackBerry, pos2g, Quaternion.identity); //coklat
        blackberry2 = Instantiate(fruitsBlackBerry, pos3h, Quaternion.identity);
        blackberry3 = Instantiate(fruitsBlackBerry, pos1i, Quaternion.identity);
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry2 = Instantiate(fruitsBlueBerry, pos2d, Quaternion.identity);
        blueberry3 = Instantiate(fruitsBlueBerry, pos4h, Quaternion.identity);
        blueberry4 = Instantiate(fruitsBlueBerry, pos2j, Quaternion.identity);
    ...
    {
        manggoes1 = Instantiate(fruitsManggoes, pos3g, Quaternion.identity); //kuning
        manggoes2 = Instantiate(fruitsManggoes, pos1h, Quaternion.identity);
        manggoes3 = Instantiate(fruitsManggoes, pos2i, Quaternion.identity);
        manggoes4 = Instantiate(fruitsManggoes, pos4k, Quaternion.identity);
