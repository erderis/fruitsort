...
public class InitFruitLv52 : MonoBehaviour
{
    ...
    {
        orange1 = Instantiate(fruitsOrange, pos2e, Quaternion.identity);
    ...
    void InstantiateApple()
    {
        ...
        apple2 = Instantiate(fruitsApple, pos3a, Quaternion.identity);
    ...
    {
        grape1 = Instantiate(fruitsGrape, pos3c, Quaternion.identity);
