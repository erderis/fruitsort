...
public class InitFruitLv313 : MonoBehaviour
{
    ...
    void InstantiateOrange()
    {
        ...
        orange2 = Instantiate(fruitsOrange, pos4h, Quaternion.identity);
    ...
    {
        banana1 = Instantiate(fruitsBanana, pos4g, Quaternion.identity); //biru
    ...
    {
        eggplant1 = Instantiate(fruitsEggplant, pos1e, Quaternion.identity); //abu
    ...
    void InstantiateBlueBerry()
    {
        ...
        blueberry4 = Instantiate(fruitsBlueBerry, pos1i, Quaternion.identity);
